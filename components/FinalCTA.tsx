      ...
      <div className="container mx-auto px-4">
        <div className="bg-[#143D30] rounded-[4rem] py-24 px-8 text-center text-white relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            <h2 className="text-5xl md:text-6xl font-serif mb-8">Ready to find your balance?</h2>
            <p className="text-white/70 font-light text-lg mb-12 tracking-wide">
              Join us for a session or event and begin your journey towards energetic resonance and lasting peace.
            </p>
